...
After bootstrapping the workspace, use the generated workspace guide at `../WORKSPACE.md` for the full local command reference, workspace layout, configuration, source modes, build outputs, and troubleshooting notes.

The generated guide is built from [`src/workspace_doc.md`](src/workspace_doc.md). Update that source file when changing workspace documentation.
